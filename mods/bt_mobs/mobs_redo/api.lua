...
--print("Mob Damage is", damage)
	...
	and self.object ~= hitter then
		...
		self.state = ""
		if throwing and throwing.playerArrows[hitter] then
			local old_view_range = self.view_range
			self.view_range = self.view_range + 10
			self:do_attack(minetest.get_player_by_name(throwing.playerArrows[hitter]))
		else
...
local toughNodes = {
	...
	["doors:door_obsidian_glass_a"] = true,
	["doors:door_obsidian_glass_b"] = true,
	["doors:door_obsidian_glass_c"] = true,
	["doors:door_obsidian_glass_d"] = true,
	["protector:trapdoor"] = true,
	["protector:trapdoor_steel"] = true,
	["stairs:slab_obsidian"] = true,
	["stairs:slab_obsidian"] = true,
	["stairs:slab_obsidian_block"] = true,
	["stairs:slab_obsidianbrick"] = true,
	["stairs:stair_obsidian"] = true,
	["stairs:stair_obsidian_block"] = true,
	["stairs:stair_obsidianbrick"] = true
}
...
function mobs:boom(self, pos, radius)
	...
	and not minetest.is_protected(pos, "") and not toughNodes[node] then
		tnt.boom(pos, {
			radius = radius,
