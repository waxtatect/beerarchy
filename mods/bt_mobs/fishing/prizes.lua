...
prizes["sea"]["little"] = {
	...
	{"fishing",  				"exoticfish_raw",		0,			"an Exotic."}
}
...
for i, v in ipairs(stuff) do
	if minetest.get_modpath(v[1]) and minetest.registered_items[v[1]..":"..v[2]] then
		table.insert(prizes["stuff"], {v[1], v[2], v[3], v[4], nrmin, v[5]})
		nrmin = nrmin + v[5]
	end
end
...
local treasure = {
	...
	{"nyancat",	"nyancat"	  , 0, "a nyan cat!"},
	{"default",	"diamondblock",	0, "a diamond block!"}
}
prizes["treasure"] = fishing.func.ignore_mod(treasure)

prizes["true_fish"] = {little = {}, big = {}}
if minetest.get_modpath("mobs_fish") then
	prizes["true_fish"]["little"]["mobs_fish:clownfish"] = {"mobs_fish", "clownfish", 0, "a Clownfish."}
	prizes["true_fish"]["little"]["mobs_fish:tropical"] = {"mobs_fish" , "tropical" , 0, "a tropical fish."}
end
if minetest.get_modpath("mobs_sharks") then
	prizes["true_fish"]["big"]["mobs_sharks:shark_lg"] = {"mobs_sharks", "shark_lg", 0, "a small Shark."}
	prizes["true_fish"]["big"]["mobs_sharks:shark_md"] = {"mobs_sharks", "shark_md", 0, "a small Shark."}
	prizes["true_fish"]["big"]["mobs_sharks:shark_sm"] = {"mobs_sharks", "shark_sm", 0, "a small Shark."}
end