...
if (minetest.get_modpath("moreores") or
	minetest.registered_items["default:mithril_ingot"]) and
...
minetest.register_craft({
	...
	recipe = {"fishing:fish_cooked", "farming:seed_wheat", "default:sand_with_kelp"}
})
