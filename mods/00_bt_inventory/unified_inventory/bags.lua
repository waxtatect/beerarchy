...
unified_inventory.register_page("bags", {
	get_formspec = function(player)
		...
		return { formspec = table.concat({
			"background[0.06,0.99;7.92,7.52;ui_bags_main_form_6.png]",
			"label[0,0;" .. F(S("Bags")) .. "]",
			"button[0,2;1,0.5;bag1;" .. F(S("Bag @1", 1)) .. "]",
			"button[1,2;1,0.5;bag2;" .. F(S("Bag @1", 2)) .. "]",
			"button[2,2;1,0.5;bag3;" .. F(S("Bag @1", 3)) .. "]",
			"button[3,2;1,0.5;bag4;" .. F(S("Bag @1", 4)) .. "]",
			"button[4,2;1,0.5;bag5;" .. F(S("Bag @1", 5)) .. "]",
			"button[5,2;1,0.5;bag6;" .. F(S("Bag @1", 6)) .. "]",
			"listcolors[#00000000;#00000000]",
			"list[detached:" .. F(player_name) .. "_bags;bag1;0,1;1,1;]",
			"list[detached:" .. F(player_name) .. "_bags;bag2;1,1;1,1;]",
			"list[detached:" .. F(player_name) .. "_bags;bag3;2,1;1,1;]",
			"list[detached:" .. F(player_name) .. "_bags;bag4;3,1;1,1;]",
			"list[detached:" .. F(player_name) .. "_bags;bag5;4,1;1,1;]",
			"list[detached:" .. F(player_name) .. "_bags;bag6;5,1;1,1;]"
		}) }
	end,
})
...
-- register bag crafts
if minetest.get_modpath("farming") ~= nil and minetest.get_modpath("mobs") ~= nil then
	minetest.register_craft({
		output = "unified_inventory:bag_small",
		recipe = {
			{"default:mese", "farming:cotton", "default:mese"},
