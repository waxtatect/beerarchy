...
dofile(minetest.get_modpath("basic_machines").."/constructor.lua") -- enable crafting of basic machines
dofile(minetest.get_modpath("basic_machines").."/electronics_constructor.lua") -- enable crafting of small electronic devices
dofile(minetest.get_modpath("basic_machines").."/digtron_constructor.lua") -- enable crafting of digtron units
