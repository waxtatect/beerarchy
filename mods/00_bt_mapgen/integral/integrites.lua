...
mobs:register_mob("integral:integrite", {
	...
	do_custom = function(self)
		...
		integral.climb(self)
		integral.search_replace(self.object:getpos(), 50, {"integral:integral_wood"}, "integral:glowing_fungal_wood")
		integral.search_replace(self.object:getpos(), 200, {"air"}, "mobs:cobweb")
	end,
})
...
mobs:register_mob("integral:integrite_soldier", {
	...
	do_custom = function(self)
		integral.climb(self)
		integral.search_replace(self.object:getpos(), 500, {"air"}, "mobs:cobweb")
	end,
})
...
mobs:register_spawn("integral:integrite", {"integral:integral_wood"}, 15, 0, 500, 10, 31000)
mobs:register_spawn("integral:integrite_soldier", {"integral:glowing_fungal_wood"}, 15, 0, 500, 10, 31000)
mobs:register_spawn("integral:integrite_queen", {"integral:glowing_fungal_wood"}, 15, 0, 4000, 10, 31000)
