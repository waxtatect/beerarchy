...
if minetest.global_exists("mesecon") then -- add mesecon adapter
	basic_machines.craft_recipes["mesecon adapter"] = {
		...
		tex = "jeija_luacontroller_top"
	}
	basic_machines.craft_recipe_order[1 + #basic_machines.craft_recipe_order] = "mesecon adapter"
end
...
local constructor_update_meta = function(pos)
	...
	meta:set_string("formspec",
		"size[8,10]"..
		"textlist[0,0;3,1.5;craft;"..table.concat(basic_machines.craft_recipe_order, ",")..
