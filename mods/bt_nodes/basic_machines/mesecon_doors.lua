...
local function door_signal_overwrite(name)
	...
	-- if table.effector then return end -- already exists, don't change
...
for _, door in ipairs(doors) do
	door_signal_overwrite(door .. "_a") -- _b, _c, _d
end
...
make_it_noclip("xpanes:trapdoor_steel_bar_open")
--]]
