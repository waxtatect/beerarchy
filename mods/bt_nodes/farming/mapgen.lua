...
-- add crops to mapgen
register_plant("potato_3", 15, 1500, nil, "", -1, farming.potato)
register_plant("tomato_7", 5, 1000, nil, "", -1, farming.tomato)
register_plant("corn_7", 12, 1000, nil, "", -1, farming.corn)
register_plant("raspberry_4", 3, 1000, nil, "", -1, farming.raspberry)
register_plant("rhubarb_3", 3, 5000, nil, "", -1, farming.rhubarb)
register_plant("blueberry_4", 3, 2000, nil, "", -1, farming.blueberry)
register_plant("beanbush", 18, 1000, nil, "", -1, farming.beans)
register_plant("grapebush", 25, 1000, nil, "", -1, farming.grapes)
--[[
...
--]]
register_plant("mint_4", 1, 2000, {"default:dirt_with_grass",
"default:dirt_with_coniferous_litter"}, "group:water", 1, farming.mint)

-- v6 mapgen compatibility for specific crops
if mg_name == "v6" then
	register_plant("carrot_8", 1, 3000, nil, "group:water", 1, farming.carrot)
	register_plant("cucumber_4", 1, 1000, nil, "group:water", 1, farming.cucumber)
	register_plant("melon_8", 1, 200, nil, "group:water", 1, farming.melon)
	register_plant("pumpkin_8", 1, 500, nil, "group:water", 1, farming.pumpkin)
	register_plant("coffee_5", 20, 5000, nil, "", -1, farming.coffee)
	-- register_plant("soy_6", 20, 50, nil, "", -1, farming.soy)
else
	-- v7 maps have a beach so plants growing near water is limited to 6 high
	register_plant("carrot_8", 1, 3000, nil, "", -1, farming.carrot)
	register_plant("cucumber_4", 1, 1000, nil, "", -1, farming.cucumber)
	register_plant("melon_8", 1, 200, {"default:dirt_with_dry_grass",
		"default:dirt_with_rainforest_litter"}, "group:water", -1, farming.melon)
	register_plant("pumpkin_8", 1, 500, nil, "", -1, farming.pumpkin)
	register_plant("coffee_5", 1001, 5000, {"default:dirt_with_dry_grass",
