...
-- Doobie
minetest.register_tool("farming:joint", {
	description = S("A big fat doobie"),
	inventory_image = "farming_joint.png",
	tool_capabilities = {
		full_punch_interval = 0.1,
		groupcaps = {
			fleshy = {times = {[2] = 1.0, [3] = 0.5}, uses = 10, maxlevel= 1},
			snappy = {times = {[2] = 1.0, [3] = 0.5}, uses = 10, maxlevel= 1},
			choppy = {times = {[3] = 0.5}, uses = 10, maxlevel= 1},
			cracky = {times = {[1] = 2.0, [2] = 1.0, [3] = 0.5}, uses = 10, maxlevel= 2},
		},
		damage_groups = {fleshy = 1, snappy = 9, choppy = 9, cracky = 9}
	},
	range = 1.8,
